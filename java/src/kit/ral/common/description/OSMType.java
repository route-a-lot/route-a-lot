...
public class OSMType {
    ...
    public static final int AMENITY_ARTS_CENTRE = 1088;
    ...
    public static final int HISTORIC_CASTLE = 1406;
    public static final int HISTORIC_MONUMENT = 1410;
    ...
    public static final int RAILWAY_LIGHT_RAIL = 1755;
    public static final int RAILWAY_RAIL = 1756;
    public static final int RAILWAY_SUBWAY = 1762;
    public static final int RAILWAY_TRAM = 1765;

    public static final int SHOP_ALCOHOL = 1801;
    public static final int SHOP_ANIME = 1802;
    public static final int SHOP_ART = 1803;
    public static final int SHOP_BABY_GOODS = 1804;
    public static final int SHOP_BAKERY = 1805;
    public static final int SHOP_BATHROOM_FURNISHING = 1806;
    public static final int SHOP_BEAUTY = 1807;
    public static final int SHOP_BED = 1808;
    public static final int SHOP_BEVERAGES = 1809;
    public static final int SHOP_BICYCLE = 1810;
    public static final int SHOP_BOOKS = 1811;
    public static final int SHOP_BOUTIQUE = 1812;
    public static final int SHOP_BUTCHER = 1813;
    public static final int SHOP_CAR = 1814;
    public static final int SHOP_CAR_REPAIR = 1815;
    public static final int SHOP_CAR_PARTS = 18016;
    public static final int SHOP_CARPET = 1817;
    public static final int SHOP_CHARITY = 1818;
    public static final int SHOP_CHEMIST = 1819;
    public static final int SHOP_CLOTHES = 1820;
    public static final int SHOP_COMPUTER = 1821;
    public static final int SHOP_CONFECTIONARY = 1822;
    public static final int SHOP_CONVENIENCE = 1823;
    public static final int SHOP_COPYSHOP = 1824;
    public static final int SHOP_CURTAIN = 1825;
    public static final int SHOP_DELI = 1826;
    public static final int SHOP_DEPARTMENT_STORE = 1827;
    public static final int SHOP_DIVE = 1828;
    public static final int SHOP_DRY_CLEANING = 1829;
    public static final int SHOP_DO_IT_YOURSELF = 1830;
    public static final int SHOP_ELECTRONICS = 1831;
    public static final int SHOP_EROTIC = 1832;
    public static final int SHOP_FABRIC = 1833;
    public static final int SHOP_FARM = 1834;
    public static final int SHOP_FISH = 1835;
    public static final int SHOP_FLORIST = 1836;
    public static final int SHOP_FRAME = 1837;
    public static final int SHOP_FURNACE = 1838;
    public static final int SHOP_FUNERAL_DIRECTORS = 1839;
    public static final int SHOP_FURNITURE = 1840;
    public static final int SHOP_GARDEN_CENTRE = 1841;
    public static final int SHOP_GAS = 1842;
    public static final int SHOP_GENERAL = 1843;
    public static final int SHOP_GIFT = 1844;
    public static final int SHOP_GLACERY = 1845;
    public static final int SHOP_GREENGROCER = 1846;
    public static final int SHOP_HAIRDRESSER = 1847;
    public static final int SHOP_HARDWARE = 1848;
    public static final int SHOP_HEARING_AIDS = 1849;
    public static final int SHOP_HERBALIST = 1850;
    public static final int SHOP_HIFI = 1851;
    public static final int SHOP_HUNTING = 1852;
    public static final int SHOP_INTERIOR_DECORATION = 1853;
    public static final int SHOP_JEWELRY = 1854;
    public static final int SHOP_KIOSK = 1855;
    public static final int SHOP_KITCHEN = 1856;
    public static final int SHOP_LAUNDRY = 1857;
    public static final int SHOP_MALL = 1858;
    public static final int SHOP_MASSAGE = 1859;
    public static final int SHOP_MOBILE_PHONE = 1860;
    public static final int SHOP_MONEY_LENDER = 1861;
    public static final int SHOP_MOTORCYCLE = 1862;
    public static final int SHOP_MUSICAL_INSTRUMENT = 1863;
    public static final int SHOP_NEWSAGENT = 1864;
    public static final int SHOP_OPTICIAN = 1865;
    public static final int SHOP_ORGANIC = 1866;
    public static final int SHOP_OUTDOOR = 1867;
    public static final int SHOP_PAINT = 1868;
    public static final int SHOP_PAWNBROKER = 1869;
    public static final int SHOP_PET = 1870;
    public static final int SHOP_RADIOTECHNICS = 1871;
    public static final int SHOP_SEAFOOD = SHOP_FISH;
    public static final int SHOP_SECOND_HAND = 1872;
    public static final int SHOP_SHOES = 1873;
    public static final int SHOP_SPORTS = 1874;
    public static final int SHOP_STATIONERY = 1875;
    public static final int SHOP_SUPERMARKET = 1876;
    public static final int SHOP_TATTOO = 1877;
    public static final int SHOP_TOBACCO = 1878;
    public static final int SHOP_TOYS = 1879;
    public static final int SHOP_TRADE = 1880;
    public static final int SHOP_VACANT = 1881;
    public static final int SHOP_VACUUM_CLEANER = 1882;
    public static final int SHOP_VARIETY_STORE = 1883;
    public static final int SHOP_VIDEO = 1884;
    public static final int SHOP_WINDOW_BLIND = 1885;
